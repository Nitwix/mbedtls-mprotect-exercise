...
#include "rsa_alt.h"
    ...
    // ADDED BY NIELS
    /**
     * \brief          Allocate a new RSA context on the heap.
     * This function compartimentalizes the memory of the context using mprotect.
     * This prevents malicious accesses that don't go through the library function.
     */
